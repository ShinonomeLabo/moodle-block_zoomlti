...
function zoomlti_meeting_finished(array $config, \stdClass $event)
{
    $repo = $config['repo'];
    ...
    userdate($event_other['join_time']);
    ...
    return [[
        ...
        'result' => [
            ...
            'extensions' => [
                ...
                'http://learninglocker.net/xapi/cmi/zoomlti/join_time' => userdate($event_other['join_time'],'%Y-%m-%d-%H-%M-%S'),
                'http://learninglocker.net/xapi/cmi/zoomlti/leave_time' => userdate($event_other['leave_time'],'%Y-%m-%d-%H-%M-%S'),
